...
<body >
	<div id="test" class="container margin-large-top">
				...
				<?php  
							...
							{
							?>
<a  class="button button-large bg-main badge-corner margin-large" href="game.php?FQ=<?php echo $row['sid']?>"  target="_black"><?php echo $row['name']?><span class="badge text-big bg-dot"><?php echo $row['jieshao']?></span></a><?php }?>	<div id="test" class="container margin-large-top">
				</body>
</html>