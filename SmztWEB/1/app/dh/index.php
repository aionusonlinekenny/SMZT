...
<div class="container margin-top">
	<form class="form" id="DHYB">
		<p class="text-yellow text-center"><strong>兑换奖励说明(基础比例:1钻石=1000累计元宝)</strong><br><strong class="text-main"> 兑换后直接发邮递需要重新进入游戏邮件提取</strong></p>
     <div class="form-group">
        ...
        <div class="form-group">
            <div class="label text-main"><label for="Rid">选择对应分区角色</label></div>
            <div class="field padding-left">
