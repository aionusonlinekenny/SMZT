...
$mail_url = 'http://127.0.0.1/gmail.php';//地址
$gpay_url = 'http://127.0.0.1/smztpay.php';//地址
$fh_url = 'http://127.0.0.1/fh.php';//地址
$gg_url = 'http://127.0.0.1/gg.php';//地址
$key ="adsfsxaqsff5041111ff789asdh11";//key
$plat='bf';//pid
...
$beizhu=$_POST['beizhu'];
		...
		if ($Scode!=$pwd){
				...
				$start['server_id']=$sid;
				$start['fqid']=$fqid;
				//$start['sname']="ngame_".$sid;
				$start['time']=time();
				$start['sign']=md5($start['user'].$start['sid'].$start['time'].$start['money'].$start['gold'].$key);
